// ---- This file is derived from ucore/libs/atomic.h ----
 ...
 * */
static inline void kset_bit(int nr, volatile void *addr)
{
 ...
 * @addr:   the address to start counting from
 * */
static inline void kclear_bit(int nr, volatile void *addr)
{
 ...
 * @addr:   the address to start counting from
 * */
static inline void kchange_bit(int nr, volatile void *addr)
{
 ...
 * */
static inline bool ktest_and_set_bit(int nr, volatile void *addr)
{
  int oldbit;
 ...
 * @addr:   the address to count from
 * */
static inline bool ktest_and_clear_bit(int nr, volatile void *addr)
{
  int oldbit;
 ...
 * @addr:   the address to count from
 * */
static inline bool ktest_and_change_bit(int nr, volatile void *addr)
{
  int oldbit;
 ...
 * @addr:   the address to count from
 * */
static inline bool ktest_bit(int nr, volatile void *addr)
{
  int oldbit;
